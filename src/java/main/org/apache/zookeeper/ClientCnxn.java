...
public class ClientCnxn {
     ...
     * @throws IOException
     */
    public ClientCnxn(ValidPath chrootPath, HostProvider hostProvider, int sessionTimeout, ZooKeeper zooKeeper,
    ...
    public ClientCnxn(ValidPath chrootPath, HostProvider hostProvider, int sessionTimeout, ZooKeeper zooKeeper,
        ...
        this.chrootPath = chrootPath.isRoot() ? null : chrootPath.toString();
